              ...
              {isOpen && (
                <div className="border-t border-slate-200 dark:border-slate-700">
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm border-collapse" style={{ minWidth: `${Math.max(600, (uniqueSubjects.length + 4) * 100)}px` }}>
                      <thead>
                        <tr className="bg-slate-100 dark:bg-slate-700/60">
                          <th className="px-3 py-2.5 text-center font-semibold text-slate-600 dark:text-slate-300 whitespace-nowrap">No.</th>
